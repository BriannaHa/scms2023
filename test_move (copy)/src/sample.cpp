...
//     subDepth_ = nh_.subscribe("/camera/depth/image_raw", 10, &Sample::depthCallback,this); 
...
// void Sample::depthCallback(const sensor_msgs::Image::ConstPtr& msg) {
//     // a mutex is used to protect the laserData_ variable when it is being written to (cannot be accessed and read elsewhere)
...
//     std::unique_lock<std::mutex> lck2(depthMtx_);
//         // LaserProcessing laserProcessing(getImage(), getDepth());
//     LaserProcessing laserProcessing(image_);
//     lck1.unlock();
//     lck2.unlock();

//     // bool squareDetected = laserProcessing.testMessages(angle_, turn_, left_, right_);
//     bool squareDetected = laserProcessing.testMessages();
//     // cout << "Square detected: " << squareDetected << std::endl;
//     // cout << "Angle: " << angle_ << std::endl;
//     // cout << "Turn: " << turn_ << std::endl;
//     // cout << "Left: " << left_ << std::endl;
//     // cout << "Right: " << right_ << std::endl;
//     return squareDetected;
// }

// void Sample::reachSquare() {
//     if(angle_<15 && left_==false && right_==false) perpendicular_ = true;

//     // turn left 90 degrees
//     else if(angle_<5 && left_==true) {
//         geometry_msgs::Twist base_cmd_turn_left;
//         ros::Rate rate(5);
//         base_cmd_turn_left.linear.x = 0; 
//         base_cmd_turn_left.linear.y = 0;
//         base_cmd_turn_left.angular.z = M_PI_4;
//         for(int n=10; n>0; n--) {
//             pubCmdVel_.publish(base_cmd_turn_left);
//             rate.sleep();
//         }
...
//     // turn parallel more than 90
//     else if(angle_>5 && turn_==2) {
//         geometry_msgs::Twist base_cmd_turn_left;
//         ros::Rate rate(5);
//         base_cmd_turn_left.linear.x = 0; 
//         base_cmd_turn_left.linear.y = 0;
//         base_cmd_turn_left.angular.z = ((90-angle_)*M_PI/180)/2;
//         for(int n=10; n>0; n--) {
//             pubCmdVel_.publish(base_cmd_turn_left);
//             rate.sleep();
//         }
...
//     // turn parallel less than 90
//     else if(angle_>5 && turn_ == 1) {
//         geometry_msgs::Twist base_cmd_turn_left;
//         ros::Rate rate(5);
//         base_cmd_turn_left.linear.x = 0; 
//         base_cmd_turn_left.linear.y = 0;
